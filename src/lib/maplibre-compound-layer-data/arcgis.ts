...
export const ARCGIS_VECTOR_BASE_LAYERS: LayerConfigEntry[] = [
	{
		type: 'LayerGroup',
		title: 'ArcGIS Vector',
		entries: [
...
export const ARCGIS_RASTER_BASE_LAYERS: LayerConfigEntry[] = [
	{
		type: 'LayerGroup',
		title: 'ArcGIS Raster',
		entries: [
...
export const ARCGIS_VECTOR_OVERLAY_LAYERS: LayerConfigEntry[] = [
	{
		type: 'LayerGroup',
		title: 'ArcGIS Vector',
		entries: [
